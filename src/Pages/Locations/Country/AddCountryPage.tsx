...
import {useAddCountryMutation} from '../../../redux/country/countryApi.ts';
...
function AddCountryPage() {
    ...
    const handleAdd = async () => {
        ...
        const selectedCountry = names.find((country) =>
            selectedCountries.includes(country.abbreviation)
        );
                ...
                <FormControl sx={{ m: 1, width: 300, mt: 3 }}>
                    <Select
                        ...
                        renderValue={(selected) => {
                            ...
                            return selected
                                .map((abbreviation) => names.find(name => name.abbreviation === abbreviation)?.country)
                                .join(', ');
                        }}
                        MenuProps={MenuProps}
                        inputProps={{ 'aria-label': 'Without label' }}
                        sx={{ borderColor: validationErrors ? 'red' : '' }}
                    >
                        ...
                        {names.map((name) => (
                            <MenuItem
                                ...
                                style={getStyles(name.abbreviation, selectedCountries, theme)}
                            >
                                {name.country}
                            </MenuItem>
                        ))}
                    ...
                    {validationErrors && validationErrors['country_name'] && (
                        <Typography variant="body2" color="error" sx={{ mt: 1 }}>
                            {validationErrors['country_name'][0]}
                        </Typography>
                    )}
                </FormControl>
            </Box>
